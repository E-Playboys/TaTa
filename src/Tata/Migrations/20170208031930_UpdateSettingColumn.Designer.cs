...
namespace Tata.Migrations
{
    ...
    [Migration("20170208031930_UpdateSettingColumn")]
    partial class UpdateSettingColumn
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Tata.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Tata.Models.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Tata.Entities.Billing", b =>
                {
                    b.HasOne("Tata.Models.ApplicationUser", "CreatedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Tata.Entities.UserProduct", b =>
                {
                    ...
                    b.HasOne("Tata.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
        }
